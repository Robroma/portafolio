...
public class PanelHotel extends JPanel {
    ...
    protected void paintComponent(Graphics g) {
        ...
        for (Habitacion habitacion : hotel.getHabitaciones()) {
            ...
            g.fillRect(x, y, habitacionWidth * habitacion.getTipo().getTipo(), habitacionHeight);
            g.setColor(Color.BLACK);
            g.drawRect(x, y, habitacionWidth * habitacion.getTipo().getTipo(), habitacionHeight);
            g.drawString(String.valueOf(habitacion.getNumero() + "(" + habitacion.getCapacidad() + ")"), x + 10, y + 20);
            x += habitacionWidth * habitacion.getTipo().getTipo() + 10;
        }
    }
